import {
  ...
  PROCESS_INSTANCE_HIDDEN_EVENT
} from '../../util/EventHelper';

var LOW_PRIORITY = 500;


export default function ProcessInstanceSettings(animation, eventBus, processInstances, elementRegistry) {
  var self = this;
...
ProcessInstanceSettings.$inject = [
  'animation',
  'eventBus',
  'processInstances',
  'elementRegistry'
